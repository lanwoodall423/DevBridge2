...
internal sealed partial class CoordinatorState
{
        ...
        IReadOnlyList<string> messages)
    {
        ...
        {
            string serialized = JsonSerializer.Serialize(response, Program.JsonOptions);
            string redacted = DiagnosticRedactor.Json(serialized);
            response = JsonSerializer.Deserialize<JsonCommandResponse>(redacted, Program.JsonOptions) ?? response;
        }
        return response;
    }
