...
internal static class OfflineTests
{
    ...
    private static int Main()
    {
        ...
        Run("baseline runtime snapshot is not applied to legacy launch", TestLegacyLaunchIgnoresBaselineRuntimeProfile);
    ...
    private static void TestLegacyLaunchIgnoresBaselineRuntimeProfile()
    {
        ...
        Assert(exitCode == 0 && ActiveMods(setup.Fixture.Root).SequenceEqual(
            ...
            "an ordinary legacy launch after baseline capture must preserve the user's current ModsConfig");
    }
